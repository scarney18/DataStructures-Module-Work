...
public abstract class AbstractMap<K, V> implements Map<K, V> {
	...
	private class KeyIterator implements Iterator<K> {
		...
		public String toString() {
			String keys = "[";
			while (entries.hasNext()){//adds each key entry to the string
				keys += entries.next().getKey().toString() + ", ";
			}
			//replaces the last ", " with empty space to preserve toString() format
